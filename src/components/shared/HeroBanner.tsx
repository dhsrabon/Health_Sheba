...
export default function HeroBanner(): React.JSX.Element {
  ...
  return (
    <section className="relative w-full bg-[#f4f7fe] overflow-hidden pt-0 pb-20 px-4 sm:px-6 lg:px-8 font-sans">
      ...
      <div className="max-w-[1400px] mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className={`lg:col-span-7 transition-all duration-1000 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-emerald-100 shadow-sm mb-6 hover:shadow-md transition-shadow mt-2">
